  ...
  <div>
    <div id="oopss">
      <div id="error-text">
        ...
        <router-link to="/" class="back">... Back to home page</router-link>
      </div>
    </div>
  </div>
</template>
...
#oopss {
  background: linear-gradient(-45deg, #184e77, #d9ed92);
  position: fixed;
  left: 0px;
  top: 0;
  width: 100%;
...
#oopss #error-text .back {
  ...
  padding: 0.7em 2em;
  border-radius: 500px;
  box-shadow: 0 20px 70px 4px rgba(0, 0, 0, 0.1), inset 7px 33px 0 0px #d9ed92;
  font-weight: 900;
